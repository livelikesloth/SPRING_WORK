package com.livelikesloth.step02.member;
 ...
 * 어노테이션에 대한 이해!
 * 
 * - 어노테이션으 붙은 클래스는 그 모양 그대로 사용되지 않고 런타임시에 변형되어서 사용된다.
 * 
 * 어떤 변형이 될까?
 * 
 * 특정클래스를 상속받기도 하고, 특정 인터페이스를 구현하기도 하고
 * 없던 메소드가 마늘어지기도 하고, 없던 필드가 추가되기도 하고 등등의 작업이 자동화 되어 있다.
 */
@Controller
