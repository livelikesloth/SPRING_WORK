...
<body>
	<div class="container">
		<h1>인덱스 입니다.</h1>
		<ul>
			<li><a href="${pageContext.request.contextPath}/member/list.do">회원
					목록 보기</a></li>
			<li><a href="${pageContext.request.contextPath}/todo/list.do">할일
					목록 보기</a></li>
			...
			<li><a href="${pageContext.request.contextPath}/send4.do">json테스트4</a></li>
			<li><a href="${pageContext.request.contextPath}/play.do">놀러가기(로그인
					필요)</a></li>
			<li><a href="${pageContext.request.contextPath}/sub/play2.do">딴데서
					놀기(로그인 필요)</a></li>
		...
		<c:choose>
			...
			<c:otherwise>
				<p>
					<strong>${id }</strong> 님 로그인중... <a href="users/logout.do">로그아웃</a>
				</p>
			</c:otherwise>
		</c:choose>
